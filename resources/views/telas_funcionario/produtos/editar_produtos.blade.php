...
<body>
    <div class="container">
        ...
        <div class="form_editarProdutos_func">
            <h1 style="color: #5c5c5c; text-align: center; margin: 0.3em;height: 1em;">Editar Produto</h1>
            <div class="scroll-view">
                ...
                <form method="POST" action="{{route('produto.update', ['id_produto'=> $produtos -> id_produto]  )}}" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn_editarProd_func">Editar</button>
                ...
                <form method="POST" action="{{ route('produto.delete', ['id_produto' => $produtos->id_produto]) }}">
                    ...
                    <button type="submit" class="btn_deletarProd_func">Excluir</button>
